          ...
          <div className="flex justify-between items-center py-4 sm:py-6">
            <div className="flex items-center">
              ...
              <nav className="hidden sm:ml-10 sm:flex sm:space-x-6 lg:space-x-8">
                ...
                <span className="text-emerald-600 font-medium text-sm lg:text-base">Profile</span>
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <button onClick={handleSignOut} className="text-xs sm:text-sm text-gray-500 hover:text-gray-700">Sign Out</button>
            </div>
          </div>
        </div>
      </header>
