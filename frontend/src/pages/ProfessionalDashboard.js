          ...
          <div className="flex justify-between items-center py-4 sm:py-6">
            <div className="flex items-center">
              ...
              <nav className="hidden sm:ml-10 sm:flex sm:space-x-6 lg:space-x-8">
                <Link to="/professional/dashboard" className="text-emerald-600 font-medium text-sm lg:text-base">Dashboard</Link>
                ...
                <Link to="/professional/leads" className="text-gray-500 hover:text-gray-700 text-sm lg:text-base">Leads</Link>
              </nav>
            </div>
